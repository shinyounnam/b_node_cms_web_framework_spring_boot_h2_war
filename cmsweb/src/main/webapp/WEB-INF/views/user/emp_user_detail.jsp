...
%>
 ...
 <div id="pop_wrap">
	...
	<table class="write_B" summary="기본정보">
		...
		<tr>
			<td>
				<a href="javascript:OnUpdatePwd('<%=obj0_0.getInt("EMP_ID")%>');" class="btn01">비밀번호 변경</a><br/><br/>
				<a href="javascript:OnDeleteOut();" class="btn01">탈퇴처리</a>
			</td>
			<td>
	...
	<input type="hidden" id="EMP_ID" name="EMP_ID" value="<%=obj0_0.getInt("EMP_ID")%>"/>
	<a href="javascript:OnAddItemView();" class="btn_more">더보기 +</a>
</div>

<script>
	function OnUpdatePwd(aEmpID)
	{
		var url = "/emp_pwd_chg/info/"+aEmpID;
		OpenWin(url,"emp_pwd_chg",700,400);
	}

	function OnDeleteOut()
	{			
		...
		if (confirm("탈퇴처리하시겠습니까?"))
		{
			...
			$.ajax({
              	url: '/emp_user_detail/delete_out',
              	type: 'POST',
                data: JSON.stringify(data),
				contentType: 'application/json',
              	success: function(data) 
				{
					Callback_OnDeleteOut(data);
              	},
				error: function(err) {
...
          	});
	...
	function Callback_OnDeleteOut(data)
	{
