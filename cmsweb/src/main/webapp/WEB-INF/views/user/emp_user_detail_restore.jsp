...
%>
 ...
 <div id="pop_wrap">
	...
	<table class="write_B" summary="기본정보">
		...
		<tr>
			<td>
				<a href="javascript:OnUpdatePwd('<%=EMP_ID%>');" class="btn01">비밀번호 변경</a><br/><br/>
				<a href="javascript:OnDeleteOut('<%=EMP_ID%>');" class="btn01">탈퇴처리</a>
			</td>
			<td>
...
<script>
	...
	{
		var url = "/emp_pwd_chg_restore/info/"+aEmpID;
		OpenWin(url,"emp_pwd_chg_restore",700,400);
	}

	function OnDeleteOut(emp_id)
	{			
		...
		if (confirm("탈퇴처리하시겠습니까?"))
		{
			...
			data.EMP_ID = emp_id;
			$.ajax({
              	url: '/emp_user_detail_restore/delete_out',
              	type: 'POST',
