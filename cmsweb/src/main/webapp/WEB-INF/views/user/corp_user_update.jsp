...
<div class="contents">
	...
	<div class="pt30"></div>
	<form id="frmBaseEdit" name="frmBaseEdit" method="post" enctype="multipart/form-data" action="/corp_user_update/submit">
		<table class="list_A" summary="">
			...
			<tr>
				<th>유료직업소개사업신고번호</th>
				<td colspan="4" style="text-align:left;">
					<input id="BIZ_NO" name="BIZ_NO" type="text" style="width:30%" value="<%=data0_0.getString("BIZ_NO")%>"/>
				</td>
			</tr>
			<tr>
				<th>직업소개소 로고</th>
				<td colspan="4" style="text-align:left;">
					...
					<% if (data0_0.getString("FILE_NAME").equals("")==false) { %>
						<img src="http://images.veteranscout.co.kr<%=data0_0.getString("FILE_URL")%><%=data0_0.getString("FILE_NAME")%>" style="height:30px;" alt="thumbnail"/>
					<% } else { %>
			...
			<tr>
				...
				<td style="text-align:left">
					<input type="text" id="REP_NAME" name="REP_NAME" style="width:80%" placeholder="대표자명" value="<%=data0_0.getString("REP_NAME")%>"/>
				</td>
				<th>대표자연락처</th>
				<td style="text-align:left" colspan="2">
					<input type="text" id="REP_TEL" name="REP_TEL" style="width:80%" placeholder="대표자연락처" value="<%=data0_0.getString("REP_TEL")%>"/>
				</td>
			</tr>
			<tr>
				<th rowspan="3">*주소</th>
			...
			<tr>
				<th>홈페이지</th>
				<td style="text-align:left">
					<input type="text" id="HOME_URL" name="HOME_URL" style="width:80%" placeholder="홈페이지" value="<%=data0_0.getString("HOME_URL")%>"/>
				</td>
				<th>이메일</th>
				<td style="text-align:left" colspan="2">
					<input type="text" id="EMAIL" name="EMAIL" style="width:80%" placeholder="이메일" value="<%=data0_0.getString("EMAIL")%>"/>
				</td>
			</tr>
			<tr>
				<th>*담당자</th>
			...
			<tr>
				<th>*소개</th>
				<td style="text-align:left" colspan="4">
					<textarea id="INTRO_TXT" style="width:95%;height:250px;" name="INTRO_TXT" row="10" placeholder="소개를 입력해주세요." ><%=data0_0.getString("INTRO_TXT")%></textarea>
				</td>
			</tr>
		</table>
		<div class="pt30"></div>
		<div style="width:100%;border:0;text-align:right;">
			...
			<a href="javascript:OnSave();" class="btn03">수정</a>
...
<script>
		...
		var maker_pos = new daum.maps.LatLng(POS_LAT, POS_LNG);
		...
		<script type='text/javascript'>
			...
			function OnSave()
			{
				...
				{
					$.ajax({
		              		url: '/corp_user_update/update_multi',
		              		type: 'POST',
