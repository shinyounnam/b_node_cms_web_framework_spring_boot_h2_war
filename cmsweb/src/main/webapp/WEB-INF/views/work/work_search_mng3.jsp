...
<div class="contents">
	...
	<div class="tab01">
		<ul>
			<li><a href="/work_search_mng">전체</a></li>
			<li><a href="/work_search_mng1">예약 현장</a></li>
			<li><a href="/work_search_mng2">진행 현장</a></li>
			<li class="on"><a href="/work_search_mng3">완료 현장</a></li><div class="font15 floatright bold">Today [<%=obj3_0.getString("TODAY_NM")%>]</div>
		</ul>
	</div>
	<div class="pt30"></div>
...
<script type="text/javascript">
	...
	function OnPage(aPage)
	{
		...
		location.href = "/work_search_mng3/move" +
				"/" + SEARCH_TYPE+
				"/"+SEARCH_TXT+
				"/"+PAGE_SIZE+
				"/"+PAGE;
