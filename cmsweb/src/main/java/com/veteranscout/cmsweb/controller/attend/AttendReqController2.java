...
@Controller
public class AttendReqController2 {  

    private String module_name = "attend_req2";
    private CommonUtil common = new CommonUtil();
    
    @RequestMapping(value = "/attend_req2")    
    // @ResponseBody    
    public ModelAndView attend_req2(CommandMap body, HttpServletRequest request) 
    {
        ...
        try {
            ...
            if(user!=null){
		        ...
		        view.setViewName("attend/attend_req2");
            }
            else
            {
    ...
    @RequestMapping(value = "/attend_req2/move/{accp_status}/{search_type}/{search_txt}/{page}")    
    // @ResponseBody    
    public ModelAndView attend_req2_move(CommandMap body, HttpServletRequest request,
