...
@Controller
public class AdminCmsOnlineResController {  

    private String module_name = "admin_cms_online_res";
    private CommonUtil common = new CommonUtil();
    
    @RequestMapping(value = "/admin_cms_online_res")    
    // @ResponseBody    
    public ModelAndView admin_cms_online_res(CommandMap body, HttpServletRequest request) 
    {
    ...
    @RequestMapping(value = "/admin_cms_online_res/move/{search_type}/{search_txt}/{page}")    
    // @ResponseBody    
    public ModelAndView admin_cms_online_res_move(CommandMap body, HttpServletRequest request,
