...
@Controller
public class AdminCmsQuestionController {  

    private String module_name = "admin_cms_question";
    private CommonUtil common = new CommonUtil();
    
    @RequestMapping(value = "/admin_cms_question")    
    // @ResponseBody    
    public ModelAndView admin_cms_question(CommandMap body, HttpServletRequest request) 
    {
    ...
    @RequestMapping(value = "/admin_cms_question/move/{search_type}/{search_txt}/{page}")    
    // @ResponseBody    
    public ModelAndView admin_cms_question_move(CommandMap body, HttpServletRequest request,
