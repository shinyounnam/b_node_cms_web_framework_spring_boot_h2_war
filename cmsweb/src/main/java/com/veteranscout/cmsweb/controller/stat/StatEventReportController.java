...
@Controller
public class StatEventReportController {  

    private String module_name = "stat_event_report";
    private CommonUtil common = new CommonUtil();
    
    @RequestMapping(value = "/stat_event_report/info/{event_id}/{s_date}/{e_date}")    
    // @ResponseBody    
    public ModelAndView stat_event_report(CommandMap body, HttpServletRequest request,
    ...
    ) 
    {
        ...
        try {
            ...
            if(user!=null){
                ...
                String strSQL = "";
                strSQL = "CALL SP_M_EVENT_LOG_REPORT_SELECT_1_1_92('"+EVENT_ID+"','"+S_DATE+"','"+E_DATE+"')";
                JSONArray jsonArray = common.execute_query(strSQL);
                view.addObject("data",jsonArray);

		        view.setViewName("stat/stat_event_report");
            }
            else
            {
