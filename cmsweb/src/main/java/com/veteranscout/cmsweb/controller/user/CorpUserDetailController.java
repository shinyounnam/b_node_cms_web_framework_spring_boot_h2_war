...
@Controller
public class CorpUserDetailController {  

    private String module_name = "corp_user_detail";
    private CommonUtil common = new CommonUtil();
    
    @RequestMapping(value = "/corp_user_detail/info/{corp_id}")    
    // @ResponseBody    
    public ModelAndView corp_user_detail_info(CommandMap body, HttpServletRequest request,
    ...
    ) 
    {
        ...
        try {
            ...
            if(user!=null){
		        ...
		        view.setViewName("user/corp_user_detail");
            }
            else
            {
