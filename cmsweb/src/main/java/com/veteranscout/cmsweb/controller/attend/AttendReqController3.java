...
@Controller
public class AttendReqController3 {  

    private String module_name = "attend_req3";
    private CommonUtil common = new CommonUtil();
    
    @RequestMapping(value = "/attend_req3")    
    // @ResponseBody    
    public ModelAndView attend_req3(CommandMap body, HttpServletRequest request) 
    {
        ...
        try {
            ...
            if(user!=null){
		        ...
		        view.setViewName("attend/attend_req3");
            }
            else
            {
    ...
    @RequestMapping(value = "/attend_req3/move/{accp_status}/{search_type}/{search_txt}/{page}")    
    // @ResponseBody    
    public ModelAndView attend_req3_move(CommandMap body, HttpServletRequest request,
