...
@Controller
public class SendMsgListController2 {  

    private String module_name = "send_msg_list2";
    private CommonUtil common = new CommonUtil();
    
    @RequestMapping(value = "/send_msg_list2/info/{corp_id}")    
    // @ResponseBody    
    ...
    ) 
    {
        ...
        try {
            ...
            if(user!=null){
                ...
                String strSQL = "";
                strSQL = "CALL SP_M_CMS_CORP_SEND_ALARM_INFO_SEARCH_1_1_65('"+CORP_ID+"','"+SEARCH_TYPE+"','"+SEARCH_TXT+"','"+PAGE+"')";
                JSONArray jsonArray = common.execute_query(strSQL);
                view.addObject("data",jsonArray);

		        view.setViewName("alarm/send_msg_list2");
            }
            else
            {
    ...
    @RequestMapping(value = "/send_msg_list2/move/{corp_id}/{search_type}/{search_txt}/{page}")    
    // @ResponseBody    
