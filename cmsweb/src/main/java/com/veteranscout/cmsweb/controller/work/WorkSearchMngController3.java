...
@Controller
public class WorkSearchMngController3 {  

    private String module_name = "work_search_mng3";
    private CommonUtil common = new CommonUtil();
    
    @RequestMapping(value = "/work_search_mng3")    
    // @ResponseBody    
    public ModelAndView work_search_mng3(CommandMap body, HttpServletRequest request) 
    {
        ...
        try {
            ...
            if(user!=null){
		        ...
		        view.setViewName("work/work_search_mng3");
            }
            else
            {
    ...
    @RequestMapping(value = "/work_search_mng3/move/{search_type}/{search_txt}/{page_size}/{page}")    
    // @ResponseBody    
    public ModelAndView work_search_mng3_move(CommandMap body, HttpServletRequest request,                                        
