...
@Controller
public class StatisticsUserAddrController {  

    private String module_name = "statistics_user_addr";
    private CommonUtil common = new CommonUtil();
    
    @RequestMapping(value = "/statistics_user_addr")    
    // @ResponseBody    
    public ModelAndView statistics_user_addr(CommandMap body, HttpServletRequest request, HttpServletResponse response) 
    {
        ...
        try {
            ...
            if(user!=null){
                ...
                String strSQL = "CALL SP_CMS_STAT_ATTEND_EMP_LIST_1_1_92('')";
                JSONArray jsonArray = common.execute_query(strSQL);
                view.addObject("data",jsonArray);

		        view.setViewName("stat/statistics_user_addr");
            }
            else
            {
