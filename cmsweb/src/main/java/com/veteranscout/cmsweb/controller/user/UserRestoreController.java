...
public class UserRestoreController {  
    ...
    private String module_name = "user_restore";
    private CommonUtil common = new CommonUtil();
    
    @RequestMapping(value = "/user_restore")    
    // @ResponseBody    
    public ModelAndView user_restore(CommandMap body, HttpServletRequest request, HttpServletResponse response) 
    {
        ...
        try {
            ...
            if(user!=null){
                ...
                String strSQL = "CALL SP_M_EMP_USER_RESTORE_LIST_PAGE_1_1_92('"+SEARCH_TYPE+"','"+SEARCH_TXT+"','"+PAGE+"')";
                JSONArray jsonArray = common.execute_query(strSQL);
                view.addObject("data",jsonArray);

		        view.setViewName("user/user_restore");
            }
            else
            {
    ...
    @RequestMapping(value = "/user_restore/move",method=RequestMethod.GET)    
    // @ResponseBody    
    public ModelAndView user_restore_move(CommandMap body, HttpServletRequest request,                
    ...
    @RequestMapping(value = "/user_restore/update_restore", produces = "application/text; charset=utf8")
    @ResponseBody
    public String update_restore(HttpServletRequest request) {                 
        ...
        try {
            ...
            if(user!=null){
                ...
                String strSQL = "";
                strSQL = "CALL SP_M_EMP_USER_RESTORE_INSERT_1_1_92_1('"+RES_ID+"','"+ADMIN_ID+"')";
