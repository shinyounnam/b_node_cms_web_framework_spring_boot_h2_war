...
@Controller
public class WorkSearchMngController2 {  

    private String module_name = "work_search_mng2";
    private CommonUtil common = new CommonUtil();
    
    @RequestMapping(value = "/work_search_mng2")    
    // @ResponseBody    
    public ModelAndView work_search_mng2(CommandMap body, HttpServletRequest request) 
    {
        ...
        try {
            ...
            if(user!=null){
		        ...
		        view.setViewName("work/work_search_mng2");
            }
            else
            {
    ...
    @RequestMapping(value = "/work_search_mng2/move/{search_type}/{search_txt}/{page_size}/{page}")    
    // @ResponseBody    
    public ModelAndView work_search_mng2_move(CommandMap body, HttpServletRequest request,                                        
