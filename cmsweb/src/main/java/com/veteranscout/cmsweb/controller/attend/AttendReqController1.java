...
@Controller
public class AttendReqController1 {  

    private String module_name = "attend_req1";
    private CommonUtil common = new CommonUtil();
    
    @RequestMapping(value = "/attend_req1")    
    // @ResponseBody    
    public ModelAndView attend_req1(CommandMap body, HttpServletRequest request) 
    {
        ...
        try {
            ...
            if(user!=null){
		        ...
		        view.setViewName("attend/attend_req1");
            }
            else
            {
    ...
    @RequestMapping(value = "/attend_req1/move/{accp_status}/{search_type}/{search_txt}/{page}")    
    // @ResponseBody    
    public ModelAndView attend_req1_move(CommandMap body, HttpServletRequest request,
