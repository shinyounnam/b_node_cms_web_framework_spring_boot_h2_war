...
@Controller
public class AdminUseLogController {  

    private String module_name = "admin_use_log";
    private CommonUtil common = new CommonUtil();
    
    @RequestMapping(value = "/admin_use_log")    
    // @ResponseBody    
    public ModelAndView admin_use_log(CommandMap body, HttpServletRequest request, HttpServletResponse response) 
    {
        ...
        try {
            ...
            if(user!=null){
                ...
                String strSQL = "CALL SP_CMS_ADMIN_USE_LOG('"+SEARCH_TYPE+"','"+SEARCH_TXT+"','"+PAGE+"')";
    ...
    @RequestMapping(value = "/admin_use_log/move/{search_type}/{search_txt}/{page}")    
    // @ResponseBody    
    public ModelAndView admin_use_log_move(CommandMap body, HttpServletRequest request,                                                                                
