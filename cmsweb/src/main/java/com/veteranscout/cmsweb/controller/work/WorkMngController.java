...
public class WorkMngController {  
    ...
    private String module_name = "work_mng";
    private CommonUtil common = new CommonUtil();
    
    @RequestMapping(value = "/work_mng")    
    // @ResponseBody    
    public ModelAndView work_mng(CommandMap body, HttpServletRequest request, HttpServletResponse response) 
    {
        ...
        try {
            ...
            if(user!=null){
                ...
                String strSQL = "CALL SP_CMS_WORK_LIST_1_1_65('"+SEARCH_TYPE+"','"+SEARCH_TXT+"','"+PAGE_SIZE+"','"+PAGE+"')";
                JSONArray jsonArray = common.execute_query(strSQL);
                view.addObject("data",jsonArray);

		        view.setViewName("work/work_mng");
            }
            else
            {
    ...
    @RequestMapping(value = "/work_mng/move/{search_type}/{search_txt}/{page_size}/{page}")    
    // @ResponseBody    
    public ModelAndView work_mng_move(CommandMap body, HttpServletRequest request,                                        
