...
@Controller
public class WorkMngController3 {  

    private String module_name = "work_mng3";
    private CommonUtil common = new CommonUtil();
    
    @RequestMapping(value = "/work_mng3")    
    // @ResponseBody    
    public ModelAndView work_mng3(CommandMap body, HttpServletRequest request) 
    {
        ...
        try {
            ...
            if(user!=null){
                ...
                String strSQL = "CALL SP_CMS_WORK_GBN_LIST_1_1_65('"+GBN_NM+"','"+SEARCH_TYPE+"','"+SEARCH_TXT+"','"+PAGE_SIZE+"','"+PAGE+"')";
                JSONArray jsonArray = common.execute_query(strSQL);
                view.addObject("data",jsonArray);

		        view.setViewName("work/work_mng3");
            }
            else
            {
    ...
    @RequestMapping(value = "/work_mng3/move/{search_type}/{search_txt}/{page_size}/{page}")    
    // @ResponseBody    
    public ModelAndView work_mng3_move(CommandMap body, HttpServletRequest request,                                        
