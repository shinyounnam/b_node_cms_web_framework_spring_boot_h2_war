...
public class MsgInfoController {  
    ...
    private String module_name = "msg_info";
    private CommonUtil common = new CommonUtil();
    
    @RequestMapping(value = "/msg_info//info/{base_type}/{corp_id}/{msg_id}")    
    // @ResponseBody    
    ...
    ) 
    {
        ...
        try {
            ...
            if(user!=null){
                ...
                String strSQL = "";
                strSQL = "CALL SP_CMS_CORP_SEND_MSG_INFO('"+BASE_TYPE+"','"+CORP_ID+"','"+MSG_ID+"')";
                JSONArray jsonArray = common.execute_query(strSQL);
                view.addObject("data",jsonArray);

		        view.setViewName("alarm/msg_info");
            }
            else
            {
