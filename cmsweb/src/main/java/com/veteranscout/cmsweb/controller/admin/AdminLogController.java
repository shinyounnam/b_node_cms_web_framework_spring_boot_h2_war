...
public class AdminLogController {  
    ...
    private String module_name = "admin_log";
    private CommonUtil common = new CommonUtil();
    
    @RequestMapping(value = "/admin_log")    
    // @ResponseBody    
    public ModelAndView admin_log(CommandMap body, HttpServletRequest request, HttpServletResponse response) 
    {
        ...
        try {
            ...
            if(user!=null){		        
                ...
                String strSQL = "CALL SP_CMS_ADMIN_LOG('"+SEARCH_TYPE+"','"+SEARCH_TXT+"','"+PAGE+"')";
                JSONArray jsonArray = common.execute_query(strSQL);
                view.addObject("data",jsonArray);

		        view.setViewName("admin/admin_log");
            }
            else
            {
    ...
    @RequestMapping(value = "/admin_log/move/{search_type}/{search_txt}/{page}")    
    // @ResponseBody    
    public ModelAndView admin_log_move(CommandMap body, HttpServletRequest request,                                                                                
