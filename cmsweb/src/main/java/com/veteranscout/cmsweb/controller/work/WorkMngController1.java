...
@Controller
public class WorkMngController1 {  

    private String module_name = "work_mng1";
    private CommonUtil common = new CommonUtil();
    
    @RequestMapping(value = "/work_mng1")    
    // @ResponseBody    
    public ModelAndView work_mng1(CommandMap body, HttpServletRequest request) 
    {
        ...
        try {
            ...
            if(user!=null){
		        ...
		        view.setViewName("work/work_mng1");
            }
            else
            {
    ...
    @RequestMapping(value = "/work_mng1/move/{search_type}/{search_txt}/{page_size}/{page}")    
    // @ResponseBody    
    public ModelAndView work_mng1_move(CommandMap body, HttpServletRequest request,                                        
