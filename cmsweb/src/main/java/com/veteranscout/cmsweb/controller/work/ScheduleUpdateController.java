...
public class ScheduleUpdateController {  
    ...
    private String module_name = "schedule_update";
    private CommonUtil common = new CommonUtil();
    
    @RequestMapping(value = "/schedule_update/info/{work_id}")    
    // @ResponseBody    
    public ModelAndView schedule_update_info(CommandMap body, HttpServletRequest request,
    ...
    ) 
    {
        ...
        try {
            ...
            if(user!=null){
                ...
                String strSQL = "";
                strSQL = "CALL SP_CMS_ADMIN_WORK_SCHEDULE_INFO('"+WORK_ID+"')";

                JSONArray jsonArray = common.execute_query(strSQL);
                view.addObject("data",jsonArray);

		        view.setViewName("work/schedule_update");
            }
            else
            {
    ...
    @RequestMapping(value = "/schedule_update/update_multi", produces = "application/text; charset=utf8")    
    @ResponseBody    
    ...
    {        
        ...
        try {
            ...
            if(user!=null){
                ...
                String strSQL = "";
                strSQL = "CALL SP_CMS_WORK_SCHEDULE_INFO_UPDATE_1_1_92('"+WORK_ID+"','"+CORP_ID+"','"+WORK_DATE+"','"+TO_WORK_DATE+"','"+NAME+"','"+POST_CODE+"','"+ADDR1+"','"+ADDR2+"','"+CHAMGO+"',"+
					 "'"+MAN_NAME+"','"+MAN_PSTN+"','"+MAN_TEL+"','"+WORK_TEL+"'," +
                     "'"+JOB_CONTENT+"','"+POS_LAT+"','"+POS_LNG+"')";
                     
                JSONArray jsonArray = common.execute_query_commit(strSQL);
                
                String strDeleteSQL = "DELETE FROM CMS_WORK_NEED WHERE WORK_ID = '"+WORK_ID+"' ";
                jsonArray = common.execute_query_commit(strDeleteSQL);
    ...
    @RequestMapping(value = "/schedule_update/delete", produces = "application/text; charset=utf8")  
    @ResponseBody    
    ...
    {        
        ...
        try {
            ...
            if(user!=null){	
                ...
                String strSQL = "";
                strSQL = "CALL SP_CMS_ADMIN_WORK_SCHEDULE_DELETE('"+WORK_ID+"') ";
